...
Page shows current GC standings (rider, team, time/gap to leader), stage results, upcoming stages; updates after each stage; data from FirstCycling scraper or ESPN cycling; no static/stale data; mobile-responsive; linked from homepage during tour
