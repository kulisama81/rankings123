...
const groups: WorldCupGroup[] = [
  buildGroup("Group A", [
    ...
    { code: "KOR", name: "South Korea", w: 1, d: 0, l: 0, gf: 2, ga: 1, outlook: "alive", status: "" },
  ...
  buildGroup("Group B", [
    ...
    { code: "CAN", name: "Canada", w: 0, d: 1, l: 0, gf: 1, ga: 1, outlook: "alive", status: "" },
  ...
  buildGroup("Group C", [
    { code: "SCO", name: "Scotland", w: 1, d: 0, l: 0, gf: 1, ga: 0, outlook: "alive", status: "" },
    { code: "MAR", name: "Morocco", w: 0, d: 1, l: 0, gf: 1, ga: 1, outlook: "advanced", status: "" },
    { code: "BRA", name: "Brazil", w: 0, d: 1, l: 0, gf: 1, ga: 1, outlook: "advanced", status: "" },
  ...
  buildGroup("Group D", [
    ...
    { code: "POL", name: "Poland", w: 1, d: 1, l: 1, gf: 3, ga: 3, outlook: "alive", status: "" },
  ...
  buildGroup("Group E", [
    ...
    { code: "JPN", name: "Japan", w: 2, d: 0, l: 1, gf: 4, ga: 3, outlook: "alive", status: "" },
  ...
  buildGroup("Group F", [
    ...
    { code: "DEN", name: "Denmark", w: 1, d: 2, l: 0, gf: 3, ga: 2, outlook: "alive", status: "" },
  ...
  buildGroup("Group K", [
    ...
    { code: "USA", name: "United States", w: 2, d: 0, l: 1, gf: 4, ga: 3, outlook: "alive", status: "" },
  ...
  buildGroup("Group L", [
    { code: "CHI", name: "Chile", w: 1, d: 1, l: 1, gf: 3, ga: 3, outlook: "alive", status: "" },
    { code: "SWE", name: "Sweden", w: 1, d: 1, l: 1, gf: 3, ga: 3, outlook: "alive", status: "" },
