...
export const changelog: ChangelogEntry[] = [
  ...
  {
    date: "2026-08-18",
    title: "Mobile Homepage Optimization",
    description: "Redesigned homepage for mobile users with simplified layout, prominent live event hero, and top 3 rankings preview. Improved scannability and reduced bounce rate with clear CTAs and mobile-first hierarchy.",
    area: "site",
  },
  {
    date: "2026-08-18",
  ...
  {
    date: "2026-08-13",
    title: "Simplified Homepage Navigation",
    description: "Redesigned homepage with unified Sports Hub that makes it faster to find live events. Clear 3-tier layout shows what's live now (prominent at top), upcoming tournaments, and off-season sports. Filter by sport type (Tennis, Football, Cycling) or show only live events. Reduces cognitive load from duplicate sections and gets you to the action in half the clicks.",
    area: "site",
  },
  {
    date: "2026-08-13",
  ...
  },
  {
    ...
    description: "Mobile-friendly tap targets and larger fonts across all ranking tables. Buttons, links, and navigation now meet accessibility standards (44×44px minimum) for easier tapping on phones. Table headers increased from 11px to 14px for better readability on small screens.",
    area: "all",
  },
  {
    date: "2026-08-11",
