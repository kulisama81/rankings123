...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE}/articles/iga-swiatek-ranking-2026`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
    { url: `${BASE}/articles/novak-djokovic-ranking-2026`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
    { url: `${BASE}/articles/coco-gauff-ranking-2026`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
    { url: `${BASE}/articles/daniil-medvedev-ranking-2026`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
    { url: `${BASE}/articles/elena-rybakina-ranking-2026`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
    { url: `${BASE}/articles/stefanos-tsitsipas-ranking-2026`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
    { url: `${BASE}/articles/jessica-pegula-ranking-2026`, lastModified: now, changeFrequency: "daily", priority: 0.85 },
